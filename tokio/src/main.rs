    ...
    loop {
        {
            ...
            match output {
                __tokio_select_util::Out::_0(_) => {
                    {
                        println!("{}", format_args!("Ctrl-C received, exiting\n"));
                    };
                    break;
                }
                __tokio_select_util::Out::_1(line) => {
                    let line = line.expect("Failed to read line");
                    if let Some(_) = line {
                        delay = Some(time::sleep(Duration::from_secs(100)));
                ...
                __tokio_select_util::Out::_2(_) => {
                    {
                        println!("{}", format_args!("Hello timer, counter: {0}\n", counter));
                    };
                ...
                __tokio_select_util::Out::_3(_) => {
                    {
                        println!("{}", format_args!("Hello timer2\n"));
                    };
                }
